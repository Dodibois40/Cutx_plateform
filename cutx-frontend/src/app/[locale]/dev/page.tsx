...
const getInitialTodos = (): TodoCategory[] => [
  ...
  },
  {
    ...
    todos: [
      ...
      { id: 'multi-11', title: 'Supprimer PopupMulticouche.backup.tsx', description: 'Fichier backup obsolète à supprimer', status: 'completed', priority: 'low' },
    ]
  },
  {
    id: 'import-export',
  ...
  },
  {
    ...
    todos: [
      ...
      { id: 'back-6', title: 'Scraping fournisseurs', description: 'Scripts import panneaux', status: 'in_progress', priority: 'medium' },
      { id: 'back-7', title: 'Rate limiting', description: 'Protection API', status: 'pending', priority: 'medium' },
      { id: 'back-8', title: 'Caching Redis', description: 'Performance requêtes', status: 'pending', priority: 'low' },
    ]
  },
  {
    id: 'testing',
  ...
  },
  {
    ...
    color: '#DC2626',
    todos: [
      { id: 'bug-1', title: 'Nettoyer fichiers backup', description: 'PopupMulticouche.backup.tsx à archiver', status: 'pending', priority: 'medium' },
      { id: 'bug-2', title: 'Clarifier ancien multicouche', description: 'Dossier configurateur-multicouche/ obsolète?', status: 'pending', priority: 'medium' },
      { id: 'bug-3', title: 'Mock API en prod', description: 'Vérifier NODE_ENV configuration', status: 'pending', priority: 'high' },
      { id: 'bug-4', title: 'Re-renders Context', description: 'Optimiser avec selector hooks', status: 'pending', priority: 'medium' },
      { id: 'bug-5', title: 'Auto-save optimisation', description: 'Debounce 500ms peut être amélioré', status: 'pending', priority: 'low' },
    ]
  },
];
